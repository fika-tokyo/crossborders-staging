...
const ja = {
  ...
  insights: {
    ...
    readMore: `続きを読む →`,
    jaOnlyNote: ``,
    soldBanner: `本物件は成約いたしました。本記事は市場分析として引き続き公開しています。`,
    soldPrice: `成約済み`,
    ctaLead: `本物件のご検討・詳細資料のご請求、または類似物件のご相談はこちらから。`,
    ctaButton: `お問い合わせ・資料請求`,
    notFound: `記事が見つかりません`,
    latestTitle: `最新レポート`,
    worksLink: `進行中の物件分析は「レポート」でご覧いただけます →`,
  },
  hero: {
    title: `境界を越え\n価値を創る`,
...
ブランド刷新・越境不動産へ`, hot: true },
  ...
  ui: {
    ...
    aboutEyebrow2: `02 · OUR JOURNEY`, aboutEyebrow3: `03 · PARTNERSHIP`, aboutTitle2: `私たちの歩み — 民泊から、無人ホテル、そして不動産の全工程へ`,
    ...
    partnershipTitle: `三つの協働のかたち`, partnershipSubtitle: `異なる分野のパートナーと、さまざまな形の価値を生み出せます。`,
    targetLabel: `対象：`, serviceLabel: `サービス内容`, valueLabel: `あなたへの価値`,
...
const tw = {
  ...
  insights: {
    eyebrow: 'INSIGHTS',
    listTitle: `市場報告`,
    listSubtitle: `以實際物件為題材,公開基於數據的市場分析與收益模擬。`,
    back: `← 報告列表`,
    statusAvailable: `銷售中`,
    statusSold: `已成交`,
    readMore: `閱讀全文 →`,
    jaOnlyNote: `本文目前僅提供日文版。`,
    soldBanner: `本物件已成交。本文作為市場分析繼續公開。`,
    soldPrice: `已成交`,
    ctaLead: `欲洽詢本物件、索取詳細資料,或諮詢類似物件,請由此聯絡我們。`,
    ctaButton: `聯絡我們・索取資料`,
    notFound: `找不到對應的文章`,
    latestTitle: `最新市場報告`,
    worksLink: `進行中的物件分析請見「市場報告」→`,
  },
  hero: {
    title: `跨越邊界\n創造價值`,
    titleEn: `Cross Borders, Create Value.`,
...
品牌煥新·跨境不動產`, hot: true },
  ...
  ui: {
    ...
    aboutEyebrow2: `02 · OUR JOURNEY`, aboutEyebrow3: `03 · PARTNERSHIP`, aboutTitle2: `我們的歷程 — 從民泊、到無人酒店、再到不動產全流程`,
    ...
    partnershipTitle: `三種合作可能`, partnershipSubtitle: `我們與不同領域的夥伴，可以創造不同形式的價值。`,
    targetLabel: `物件：`, serviceLabel: `服務內容`, valueLabel: `對您的價值`,
    discussThis: `諮詢此合作 →`,
...
const zh = {
  ...
  insights: {
    eyebrow: 'INSIGHTS',
    listTitle: `市场报告`,
    listSubtitle: `以实际物件为题材,公开基于数据的市场分析与收益模拟。`,
    back: `← 报告列表`,
    statusAvailable: `销售中`,
    statusSold: `已成交`,
    readMore: `阅读全文 →`,
    jaOnlyNote: `本文目前仅提供日文版。`,
    soldBanner: `本物件已成交。本文作为市场分析继续公开。`,
    soldPrice: `已成交`,
    ctaLead: `咨询本物件、索取详细资料,或就类似物件进行咨询,请由此联系我们。`,
    ctaButton: `联系我们・索取资料`,
    notFound: `找不到对应的文章`,
    latestTitle: `最新市场报告`,
    worksLink: `进行中的物件分析请见「市场报告」→`,
  },
  hero: {
    title: `跨越边界\n创造价值`,
    titleEn: `Cross Borders, Create Value.`,
...
品牌焕新·跨境不动产`, hot: true },
  ...
  ui: {
    ...
    aboutEyebrow2: `02 · OUR JOURNEY`, aboutEyebrow3: `03 · PARTNERSHIP`, aboutTitle2: `我们的历程 — 从民宿、到无人酒店、再到不动产全流程`,
    ...
    partnershipTitle: `三种合作可能`, partnershipSubtitle: `我们与不同领域的伙伴，可以创造不同形式的价值。`,
    targetLabel: `对象：`, serviceLabel: `服务内容`, valueLabel: `对您的价值`,
    discussThis: `咨询此合作 →`,
...
const en = {
  ...
  insights: {
    eyebrow: 'INSIGHTS',
    listTitle: `Insights`,
    listSubtitle: `Data-driven market analysis and revenue simulations, built around real properties.`,
    back: `← Insights`,
    statusAvailable: `Available`,
    statusSold: `Sold`,
    readMore: `Read more →`,
    jaOnlyNote: `This article is currently available in Japanese only.`,
    soldBanner: `This property has been sold. The article remains available as market analysis.`,
    soldPrice: `Sold`,
    ctaLead: `Interested in this property, the full financial model, or a similar assessment of your own building? Contact us here.`,
    ctaButton: `Contact us`,
    notFound: `Article not found`,
    latestTitle: `Latest insight`,
    worksLink: `See our current property analyses in Insights →`,
  },
  hero: {
    title: `Cross Borders\nCreate Value`,
    titleEn: ``,
...
Rebrand · cross-border real estate`, hot: true },
  ...
  ui: {
    ...
    aboutEyebrow2: `02 · OUR JOURNEY`, aboutEyebrow3: `03 · PARTNERSHIP`, aboutTitle2: `Our journey — vacation rentals, staffless hotels, full-cycle real estate`,
    ...
    partnershipTitle: `Three ways to partner`, partnershipSubtitle: `We create value in different ways, depending on the partner.`,
    targetLabel: `For: `, serviceLabel: `What we offer`, valueLabel: `Value to you`,
